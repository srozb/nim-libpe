type
  ...
  IMAGE_IMPORT_BY_NAME* {.bycopy, importc.} = object ##   import name entry
    Hint*: uint16
    Name*: cstring
  ...
  IMAGE_THUNK_DATA64* {.bycopy, importc.} = object
